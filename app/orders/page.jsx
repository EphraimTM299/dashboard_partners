                ...
                <tr className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4">
                    <select
                      ...
                      className=" border border-blue-50 text-gray-900 text-sm rounded-lg focus:ring-0 focus:ring-offset-00 block w-3/4 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white "
                      name=""
                      id=""
                    >
                      ...
                      count={item.cartItems.map((cartItem, i) => (
                        <>
                          ...
                          >
                            <a
                              href="#"
                              className="block max-w-sm p-6 bg-white border w-1/2 border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700"
                            >
                              <h5 className="mb-2 text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                                {cartItem.productName}
                              </h5>
                              <p className="font-normal text-l text-black dark:text-gray-400">
                                Service:{" "}
